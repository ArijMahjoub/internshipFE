function _typeof(e) {
    ...
    return function() {
        ...
        return t && t.requirejs || (t ? i = t : t = {}, function(e) {
            ...
            function m(e, t) {
                var n, i, r, s, o, a, l, c, d, p, h, g = t && t.split("/"),
                    m = u.map,
                    v = m && m["*"] || {};
                if (e) {
                    for (o = (e = e.split("/")).length - 1, u.nodeIdCompat && f.test(e[o]) && (e[o] = e[o].replace(f, "")), "." === e[0].charAt(0) && g && (e = g.slice(0, g.length - 1).concat(e)), d = 0; d < e.length; d++)
            ...
            function v(t, n) {
                return function() {
                    ...
                    return "string" != typeof i[0] && 1 === i.length && i.push(null), s.apply(e, i.concat([t, n]))
                }
            }
            ...
            o = function(e, t) {
                var n, i, r = b(e),
                    s = r[0],
                    o = t[1];
                return e = r[1], s && (n = _(s = m(s, o))), s ? e = n && n.normalize ? n.normalize(e, (i = o, function(e) {
                    return m(e, i)
                })) : m(e, o) : (s = (r = b(e = m(e, o)))[0], e = r[1], s && (n = _(s))), {
                    f: s ? s + "!" + e : e,
                    n: e,
                    pr: s,
                    p: n
                ...
                if (m = $(r = r || t), "undefined" === x || "function" === x) {
                    for (n = !n.length && i.length ? ["require", "exports", "module"] : n, f = 0; f < n.length; f += 1)
                        if ("require" === (u = (h = o(n[f], m)).f)) w[f] = a.require(t);
                        else if ("exports" === u) w[f] = a.exports(t), b = !0;
                    else if ("module" === u) s = w[f] = a.module(t);
                    else if (g(l, u) || g(c, u) || g(d, u)) w[f] = _(u);
                    else {
                        if (!h.p) throw new Error(t + " missing " + u);
                        h.p.load(h.n, v(r, !0), y(u), {}), w[f] = l[u]
                    }
                    p = i ? i.apply(l[t], w) : void 0, t && (s && s.exports !== e && s.exports !== l[t] ? l[t] = s.exports : p === e && b || (l[t] = p))
                } else t && (l[t] = i)
            }, n = i = s = function(n, i, r, l, c) {
                if ("string" == typeof n) return a[n] ? a[n](i) : _(o(n, $(i)).f);
                if (!n.splice) {
            ...
            return t.GetUniqueElementId = function(e) {
                ...
                return null != n ? n : (n = e.id ? "select2-data-" + e.id : "select2-data-" + (++r).toString() + "-" + t.generateChars(4), e.setAttribute("data-select2-id", n), n)
            ...
            return t.Extend(n, t.Observable), n.prototype.render = function() {
                ...
                this.data.current(function(i) {
                    ...
                    n.$results.find(".select2-results__option--selectable").each(function() {
                        var n = e(this),
                            ...
                            s = "" + i.id;
                        null != i.element && i.element.selected || null == i.element && r.indexOf(s) > -1 ? (this.classList.add("select2-results__option--selected"), n.attr("aria-selected", "true")) : (this.classList.remove("select2-results__option--selected"), n.attr("aria-selected", "false"))
                    })
                })
                ...
                for (var o in (null != n.element && s.call(n.element, ":disabled") || null == n.element && n.disabled) && (r["aria-disabled"] = "true", i.classList.remove("select2-results__option--selectable"), i.classList.add("select2-results__option--disabled")), null == n.id && i.classList.remove("select2-results__option--selectable"), null != n._resultId && (i.id = n._resultId), n.title && (i.title = n.title), n.children && (r.role = "group", r["aria-label"] = n.text, i.classList.remove("select2-results__option--selectable"), i.classList.add("select2-results__option--group")), r) {
                    var a = r[o];
                    i.setAttribute(o, a)
                }
                if (n.children) {
            ...
            return t.Extend(i, t.Observable), i.prototype.render = function() {
                ...
                this._tabindex = 0, null != t.GetData(this.$element[0], "old-tabindex") ? this._tabindex = t.GetData(this.$element[0], "old-tabindex") : null != this.$element.attr("tabindex") && (this._tabindex = this.$element.attr("tabindex")), n.attr("title", this.$element.attr("title")), n.attr("tabindex", this._tabindex), n.attr("aria-disabled", "false");
                var i = this.$element.attr("aria-describedby");
                return null !== i && "" !== i && n.attr("aria-describedby", i), this.$selection = n, n
            ...
            return n.Extend(r, t), r.prototype.render = function() {
                ...
                return e[0].classList.add("select2-selection--single"), e.html('<span class="select2-selection__rendered"></span><span class="select2-selection__arrow" role="presentation"><span class="forminator-icon-chevron-down" aria-hidden="true"></span></span>'), e
                ...
                if (0 === e.length) return this.clear(), void("vars" === this.options.get("theme") && this.$selection.find(".select2-selection__rendered").html('<span class="forminator-icon-plus-circle" aria-hidden="true"></span>'));
                var t = e[0],
            ...
            return n.Extend(i, t), i.prototype.render = function() {
                ...
                if (this.clear(), 0 !== t) {
                    for (var i = [], r = this.$selection.find(".select2-selection__rendered").attr("id") + "-choice-", s = 0; s < t; s++) {
                        ...
                        o.id ? c += o.id : c += n.generateChars(4), a.find(".select2-selection__choice__display").append(l).attr("id", c);
                        var u = o.title || o.text;
                        u && a.attr("title", u);
                        var d = this.options.get("translations").get("removeItem"),
                            p = a.find(".select2-selection__choice__remove");
                        p.attr("title", d()), p.attr("aria-label", d()), p.attr("aria-describedby", c), n.StoreData(a[0], "data", o), i.push(a)
                    }
            ...
            return i.prototype.bind = function(e, t, n) {
                ...
                if (t.call(this, i), this.$selection.find(".select2-selection__clear").remove(), this.$selection[0].classList.remove("select2-selection--clearable"), !(this.$selection.find(".select2-selection__placeholder").length > 0 || 0 === i.length)) {
                    ...
                    o.attr("title", s()), o.attr("aria-label", s()), o.attr("aria-describedby", r), n.StoreData(o[0], "data", i), this.$selection.prepend(o), this.$selection[0].classList.add("select2-selection--clearable")
                }
            }, i
            ...
            return i.prototype.render = function(t) {
                ...
                var s = this,
                    o = i.id + "-results",
                    a = i.id + "-container";
                e.call(this, i, r), s.$search.attr("aria-describedby", a), i.on("open", function() {
            ...
            return t.prototype.bind = function(t, n, i) {
                ...
                t.call(this, n, i), n.on("*", function(t, n) {
                    if (-1 !== s.indexOf(t)) {
                        ...
                        r.$element.trigger(i), -1 !== o.indexOf(t) && (n.prevented = i.isDefaultPrevented())
                    }
                })
            }, t
            ...
            return t.Extend(i, e), i.prototype.current = function(e) {
                ...
                if (this.$element.prop("multiple")) this.current(function(n) {
                    ...
                    for (var r = 0; r < e.length; r++) {
                        var s = e[r].id; - 1 === i.indexOf(s) && i.push(s)
                    }
            ...
            return t.Extend(i, e), i.prototype._applyDefaults = function(e) {
                ...
                function s() {
                    var n = r.transport(r, function(n) {
                        ...
                        i.options.get("debug") && window.console && console.error && (r && r.results && Array.isArray(r.results) || console.error("Select2: The AJAX results did not return an array in the `results` key of the response.")), t(r)
                    }, function() {
                ...
                "function" == typeof r.url && (r.url = r.url.call(this.$element, e)), "function" == typeof r.data && (r.data = r.data.call(this.$element, e)), this.ajaxOptions.delay && null != e.term ? (this._queryTimeout && window.clearTimeout(this._queryTimeout), this._queryTimeout = window.setTimeout(s, this.ajaxOptions.delay)) : s()
            }, i
            ...
            function t(e, t, n) {
                ...
                void 0 !== s && (this.insertTag = s), e.call(this, t, n);
                var o = i.length;
                if (Array.isArray(i))
                    for (var a = 0; a < o; a++) {
                        var l = i[a],
            ...
            return t.prototype.query = function(e, t, n) {
                ...
                this._removeOldTags(), null != t.term && null == t.page ? e.call(this, t, function e(r, s) {
                    for (var o = r.results, a = o.length, l = 0; l < a; l++) {
                        ...
                        if ((c.text || "").toUpperCase() === (t.term || "").toUpperCase() || u) return !s && (r.data = o, void n(r))
                    }
                    if (s) return !0;
                    var d = i.createTag(t);
                    if (null != d) {
                        var p = i.option(d);
                        p.attr("data-select2-tag", "true"), i.addOptions([p]), i.insertTag(o, d)
                    }
                    r.results = o, n(r)
                }) : e.call(this, t, n)
            ...
            return t.prototype.bind = function(e, t, n) {
                ...
                for (var s = i.get("tokenSeparators") || [], o = n.term, a = 0, l = this.createTag || function(e) {
                    ...
                    if (-1 !== s.indexOf(c)) {
                        ...
                        null != d ? (r(d), o = o.substr(a + 1) || "", a = 0) : a++
                    } else a++
                }
                return {
                    term: o
            ...
            return n.prototype.bind = function(e, t, n) {
                ...
                t.attr("class", n.attr("class")), t.removeClass("select2"), t.addClass("forminator-select-dropdown-container--open"), t.attr("tabindex", "-1"), t[0].classList.remove("select2"), t[0].classList.add("select2-container--open"), t.css({
                    position: "absolute",
                    top: -999999
                }), this.$container = n
            ...
            return t.prototype.render = function(t) {
                ...
                return -1 !== i.indexOf(":all:") && (i = i.replace(":all:", ""), e.copyNonInternalCssClasses(n[0], this.$element[0])), n.addClass("forminator-select-dropdown"), n.addClass(i), n
            }, t
            ...
            return t.prototype.highlightFirstItem = function(t) {
                ...
                if (n.length > 0) {
                    ...
                    if (r && r.getAttribute && "true" === r.getAttribute("data-select2-tag")) return void i.trigger("mouseenter")
                }
                t.call(this)
            }, t
            ...
            return T.prototype.apply = function(u) {
                if (null == (u = e.extend(!0, {}, this.defaults, u)).dataAdapter && (null != u.ajax ? u.dataAdapter = f : null != u.data ? u.dataAdapter = h : u.dataAdapter = p, u.minimumInputLength > 0 && (u.dataAdapter = c.Decorate(u.dataAdapter, v)), u.maximumInputLength > 0 && (u.dataAdapter = c.Decorate(u.dataAdapter, y)), u.maximumSelectionLength > 0 && (u.dataAdapter = c.Decorate(u.dataAdapter, _)), u.tags && (u.dataAdapter = c.Decorate(u.dataAdapter, g)), null == u.tokenSeparators && null == u.tokenizer || (u.dataAdapter = c.Decorate(u.dataAdapter, m))), null == u.resultsAdapter && (u.resultsAdapter = t, null != u.ajax && (u.resultsAdapter = c.Decorate(u.resultsAdapter, x)), null != u.placeholder && (u.resultsAdapter = c.Decorate(u.resultsAdapter, w)), u.selectOnClose && (u.resultsAdapter = c.Decorate(u.resultsAdapter, S)), u.tags && (u.resultsAdapter = c.Decorate(u.resultsAdapter, O))), null == u.dropdownAdapter) {
                    if (u.multiple) u.dropdownAdapter = b;
                    else {
                        var d = c.Decorate(b, $);
                        u.dropdownAdapter = d
                    }
                    0 !== u.minimumResultsForSearch && (u.dropdownAdapter = c.Decorate(u.dropdownAdapter, D)), u.closeOnSelect && (u.dropdownAdapter = c.Decorate(u.dropdownAdapter, C)), null != u.dropdownCssClass && (u.dropdownAdapter = c.Decorate(u.dropdownAdapter, L)), u.dropdownAdapter = c.Decorate(u.dropdownAdapter, A)
                }
                null == u.selectionAdapter && (u.multiple ? u.selectionAdapter = i : u.selectionAdapter = n, null != u.placeholder && (u.selectionAdapter = c.Decorate(u.selectionAdapter, r)), u.allowClear && (u.selectionAdapter = c.Decorate(u.selectionAdapter, s)), u.multiple && (u.selectionAdapter = c.Decorate(u.selectionAdapter, o)), null != u.selectionCssClass && (u.selectionAdapter = c.Decorate(u.selectionAdapter, a)), u.selectionAdapter = c.Decorate(u.selectionAdapter, l)), u.language = this._resolveLanguage(u.language), u.language.push("en");
                for (var E = [], T = 0; T < u.language.length; T++) {
                    var I = u.language[T]; - 1 === E.indexOf(I) && E.push(I)
                }
            ...
            var r = function e(i, r) {
                ...
                }), i[0].classList.add("select2-hidden-accessible"), i.attr("aria-hidden", "true"), i.addClass("forminator-screen-reader-only"), this._syncAttributes(), n.StoreData(i[0], "select2", this), i.data("select2", this)
            };
            return n.Extend(r, n.Observable), r.prototype._generateId = function(e) {
                ...
                this.on("open", function() {
                    ...
                    var r = n.which;
                    if (t.isOpen()) r === i.ENTER ? (t.trigger("results:select"), n.preventDefault()) : r === i.SPACE && n.ctrlKey ? (t.trigger("results:toggle"), n.preventDefault()) : r === i.UP ? (t.trigger("results:previous"), n.preventDefault()) : r === i.DOWN ? (t.trigger("results:next"), n.preventDefault()) : r !== i.ESC && r !== i.TAB || (t.close(), n.preventDefault());
                    else if (r === i.ENTER || r === i.SPACE || r === i.DOWN) t.open(), n.preventDefault();
                    else if (r === i.DOWN) null != this.$element.find("option:selected").next().val() && (this.$element.val(this.$element.find("option:selected").next().val()), this.$element.trigger("change")), n.preventDefault();
                    else if (r === i.UP) null != this.$element.find("option:selected").prev().val() && (this.$element.val(this.$element.find("option:selected").prev().val()), this.$element.trigger("change")), n.preventDefault();
                    else {
                        var s = this.$element.find("option:selected").text(),
                            ...
                            c = s;
                        a.each(function(t) {
                            return console.log(s), "" !== s && s[0].toLowerCase() === o ? e(this).text() === s && t !== l ? (c = e(a[t + 1]).val(), !1) : void 0 : (c = e(this).val(), !1)
                        }), c !== s && (t.$element.val(c), t.$element.trigger("change"))
                    }
                })
                ...
                return t.attr("dir", this.options.get("dir")), this.$container = t, this.$container[0].classList.add("forminator-select"), "default" !== this.options.get("theme") && this.$container[0].classList.add("forminator-select-theme--" + this.options.get("theme")), n.StoreData(t[0], "element", this.$element), t
            }, r
                ...
                e.fn.FUIselect2 = function(t) {
                    ...
                    if ("string" == typeof t) {
                        ...
                        return this.each(function() {
                            ...
                            null == e && window.console && console.error && console.error("The FUIselect2('" + t + "') method was called on an element that is not using Select2."), i = e[t].apply(e, o)
                        }), s.indexOf(t) > -1 ? this : i
                    }
                    throw new Error("Invalid arguments for FUIselect2: " + t)
                }
            }
            return null == e.fn.FUIselect2.defaults && (e.fn.FUIselect2.defaults = i), n
        }), {
            define: t.define,
            require: t.require
        }
