...
function(C) {
    ...
    function t() {
        h().init(), -1 < navigator.appVersion.toLowerCase().indexOf("mac") && edgtf.body.hasClass("edgtf-smooth-scroll") && edgtf.body.removeClass("edgtf-smooth-scroll"), s().init(), C("#edgtf-back-to-top").on("click", function(e) {
            ...
            var e = C(this).scrollTop(),
                ...
                e = 0 < e ? e + t / 2 : 1;
            r(e < 1e3 ? "off" : "on")
        }), l(), c(), g(), p(), (e = C(".edgtf-preload-background")).length && e.each(function() {
            var e, t, a = C(this);
            "" !== a.css("background-image") && "none" !== a.css("background-image") ? (t = (t = (t = a.attr("style")).match(/url\(["']?([^'")]+)['"]?\)/)) ? t[1] : "") && ((e = new Image).src = t, C(e).on("load", function() {
                a.removeClass("edgtf-preload-background")
            })) : C(window).on("load", function() {
                a.removeClass("edgtf-preload-background")
            })
        }), f();
        var d, e = C(".edgtf-row-has-line");
        e.length && (d = "", e.each(function() {
            var a, e = C(this),
                t = (e.find(".edgtf-row-line"), "." + (t = (t = e).attr("class").split(/\s+/), a = "", C.each(t, function(e, t) {
                    -1 !== t.search("vc_custom") && (a = t)
                }), a)); - 1 !== e.attr("class").search("vc_custom") && (26 < parseInt(e.css("margin-top"), 10) || 26 < parseInt(e.css("margin-bottom"), 10)) && (d += t + "{", e.hasClass("edgtf-row-line-top") ? d += "margin-top: " + (parseInt(e.css("margin-top"), 10) + 26) + "px !important;" : e.hasClass("edgtf-row-line-bottom") && (d += "margin-bottom: " + (parseInt(e.css("margin-bottom"), 10) + 26) + "px !important;"), d += "}")
        }), C("head").find('style[data-type="vc_shortcodes-custom-css"]').append(d)), (e = C(".edgtf-search-post-type")).length && e.each(function() {
            var e, t = C(this),
                a = t.find(".edgtf-post-type-search-field"),
                d = t.siblings(".edgtf-post-type-search-results"),
                n = t.find(".edgtf-search-loading"),
                o = t.find(".edgtf-search-icon"),
                i = (n.addClass("edgtf-hidden"), t.data("post-type"));
            a.on("keyup paste", function() {
                var t = C(this);
                t.attr("autocomplete", "off"), n.removeClass("edgtf-hidden"), o.addClass("edgtf-hidden"), clearTimeout(e), e = setTimeout(function() {
                    var e = t.val();
                    e.length < 3 ? (d.html(""), d.fadeOut(), n.addClass("edgtf-hidden"), o.removeClass("edgtf-hidden")) : C.ajax({
                        type: "POST",
                        data: {
                            action: "dishup_edge_search_post_types",
                            term: e,
                            postType: i
                        },
                        ...
                        success: function(e) {
                            e = JSON.parse(e);
                            "success" === e.status && (n.addClass("edgtf-hidden"), o.removeClass("edgtf-hidden"), d.html(e.data.html), d.fadeIn())
                        },
                        error: function(e, t, a) {
                            console.log("Status: " + t), console.log("Error: " + a), n.addClass("edgtf-hidden"), o.removeClass("edgtf-hidden"), d.fadeOut()
                        }
                    })
                }, 500)
            }), a.on("focusout", function() {
                n.addClass("edgtf-hidden"), o.removeClass("edgtf-hidden"), d.fadeOut()
            })
        })
    }
    ...
    function a() {
        function e(e) {
            ...
            new PhotoSwipe(e, PhotoSwipeUI_Default, t, a).init()
        }
        x(), d = function(e) {
            var e = e.closest(".edgtf-image-gallery").find(".edgtf-ig-lightbox"),
                a = [];
            return 0 < e.length && e.each(function(e, t) {
                t = {
                    ...
                    w: C(t).data("width"),
                    h: C(t).data("height"),
                    title: C(t).attr("title")
                };
                a.push(t)
            }), a
        }, a = C(".edgtf-image-gallery.edgtf-image-behavior-lightbox"), o = a.find(".edgtf-ig-lightbox"), a.length && o.on("click", e), edgtf.body.hasClass("edgtf-smooth-page-transitions") && (edgtf.body.hasClass("edgtf-smooth-page-transitions-preloader") && ((t = C("body > .edgtf-smooth-transition-loader.edgtf-mimic-ajax")).fadeOut(500), C(window).on("pageshow", function(e) {
            e.originalEvent.persisted && t.fadeOut(500)
        })), edgtf.body.hasClass("edgtf-smooth-page-transitions-fadeout") && C("a").on("click", function(e) {
            var t = C(this);
            (t.parents(".edgtf-shopping-cart-dropdown").length || t.parent(".product-remove").length) && t.hasClass("remove") || 1 === e.which && 0 <= t.attr("href").indexOf(window.location.host) && void 0 === t.data("rel") && void 0 === t.attr("rel") && !t.hasClass("lightbox-active") && (void 0 === t.attr("target") || "_self" === t.attr("target")) && t.attr("href").split("#")[0] !== window.location.href.split("#")[0] && (e.preventDefault(), C(".edgtf-wrapper-inner").fadeOut(1e3, function() {
                window.location = t.attr("href")
            }))
        })), u().init(), m();
        var d, t, a = C(".edgtf-no-animations-on-touch"),
            n = !0,
            o = C(".edgtf-overlapping-content-holder"),
            a = (a.length && (n = !1), o.length && o.each(function() {
                var e = C(this);
                n ? edgtf.body.hasClass("edgtf-overlapping-content-on-loading") ? setTimeout(function() {
                    e.addClass("edgtf-animated")
                }, 300) : e.appear(function() {
                    setTimeout(function() {
                        e.addClass("edgtf-animated")
                    }, 100)
                }, {
            ...
            }), C(".edgtf-no-animations-on-touch")),
            i = !0,
            o = C(".edgtf-overlapping-image-animated");
        a.length && (i = !1), o.length && o.each(function() {
            var e = C(this);
            i ? e.appear(function() {
                setTimeout(function() {
                    e.addClass("edgtf-animated")
    ...
    function i(e) {
        ...
        window.onmousewheel = document.onmousewheel = n, document.onkeydown = o
    }, e.edgtfOwlSlider = p, e.edgtfInitParallax = x, e.edgtfInitSelfHostedVideoPlayer = l, e.edgtfSelfHostedVideoSize = c, e.edgtfPrettyPhoto = f, e.edgtfStickySidebarWidget = u, e.getLoadMoreData = function(e) {
        var t, a = e.data(),
            d = {};
        for (t in a) a.hasOwnProperty(t) && void 0 !== a[t] && !1 !== a[t] && (d[t] = a[t]);
        return d
    }, e.setLoadMoreAjaxData = function(e, t) {
        var a, d = {
            action: t
        };
        for (a in e) e.hasOwnProperty(a) && void 0 !== e[a] && !1 !== e[a] && (d[a] = e[a]);
        return d
    }, e.edgtfOnDocumentReady = t, e.edgtfOnWindowLoad = a, e.edgtfOnWindowResize = d, C(document).ready(t), C(window).on("load", a), C(window).resize(d);
    var s = function() {
        function d() {
            if ("" !== (a = window.location.hash.split("#")[1]) && 0 < C('[data-edgtf-anchor="' + a + '"]').length) {
                var e = C(".edgtf-main-menu a, .edgtf-mobile-nav a, .edgtf-fullscreen-menu a"),
                    t = a,
                    a = t !== "" ? C('[data-edgtf-anchor="' + t + '"]') : "";
                if (t !== "" && a.length > 0) {
                    a = a.offset().top;
                    a = a - o(a) - edgtfGlobalVars.vars.edgtfAddForAdminBar;
        ...
        var n = function(t) {
                C(".edgtf-main-menu, .edgtf-mobile-nav, .edgtf-fullscreen-menu").each(function() {
                    var e = C(this);
            ...
            init: function() {
                ...
                C("[data-edgtf-anchor]").length && (edgtf.document.on("click", ".edgtf-main-menu a, .edgtf-fullscreen-menu a, .edgtf-btn, .edgtf-anchor, .edgtf-mobile-nav a", function() {
                    var e = C(this),
                        ...
                        a = "" !== t ? C('[data-edgtf-anchor="' + t + '"]') : "";
                    if ("" !== t && 0 < a.length) return a = (a = a.offset().top) - o(a) - edgtfGlobalVars.vars.edgtfAddForAdminBar, n(e), edgtf.html.stop().animate({
                        scrollTop: Math.round(a)
                    }, 1e3, function() {
                        history.pushState && history.pushState(null, "", "#" + t)
                    }), !1
                }), e = C("[data-edgtf-anchor]"), "/" !== (a = window.location.href.split("#")[0]).substr(-1) && (a += "/"), e.waypoint(function(e) {
                    "down" === e && (t = (0 < C(this.element).length ? C(this.element) : C(this)).data("edgtf-anchor"), n(C("a[href='" + a + "#" + t + "']")))
                }, {
                    offset: "50%"
                }), e.waypoint(function(e) {
                    "up" === e && (t = (0 < C(this.element).length ? C(this.element) : C(this)).data("edgtf-anchor"), n(C("a[href='" + a + "#" + t + "']")))
                }, {
                    offset: function() {
    ...
    var h = function() {
        ...
        return {
            init: function() {
                e.length && e.each(function() {
                    var e, t, a, d;
                    void 0 !== (e = C(this)).data("hover-color") && (t = function(e) {
                        e.data.icon.css("color", e.data.color)
                    }, a = e.data("hover-color"), d = e.css("color"), "" !== a && (e.on("mouseenter", {
                        icon: e,
                        color: a
                    }, t), e.on("mouseleave", {
                        icon: e,
    ...
    function x() {
        var e = C(".edgtf-parallax-row-holder");
        e.length && e.each(function() {
            var e = C(this),
    ...
    function u() {
        var o, i, e = C(".edgtf-widget-sticky-sidebar"),
            t = C(".edgtf-page-header"),
        ...
        function a() {
            c.length && C.each(c, function(e) {
                c[e].object;
                var t, a, d = c[e].offset,
                    n = c[e].position,
                    o = c[e].height,
                    i = c[e].width,
                    s = c[e].sidebarHolder,
                    e = c[e].sidebarHolderHeight;
                edgtf.body.hasClass("edgtf-fixed-on-scroll") ? (t = C(".edgtf-fixed-wrapper.fixed")).length && (r = t.outerHeight() + edgtfGlobalVars.vars.edgtfAddForAdminBar) : edgtf.body.hasClass("edgtf-no-behavior") && (r = edgtfGlobalVars.vars.edgtfAddForAdminBar), 1024 < edgtf.windowWidth && s.length ? (t = -(n - r), a = o - n - 40, n = e + d - r - n - edgtfGlobalVars.vars.edgtfTopBarHeight, edgtf.scroll >= d - r && o < e ? (s.hasClass("edgtf-sticky-sidebar-appeared") ? s.css({
                    top: t + "px"
                }) : s.addClass("edgtf-sticky-sidebar-appeared").css({
                    position: "fixed",
                    top: t + "px",
                    width: i,
                    "margin-top": "-10px"
                    ...
                    "margin-top": "0"
                }, 200), edgtf.scroll + a >= n ? (d = e - a + t - r, s.css({
                    position: "absolute",
                    top: d + "px"
                })) : s.hasClass("edgtf-sticky-sidebar-appeared") && s.css({
                    position: "fixed",
                    top: t + "px"
                })) : s.removeClass("edgtf-sticky-sidebar-appeared").css({
                    position: "relative",
                    top: "0",
                    width: "auto"
                })) : s.removeClass("edgtf-sticky-sidebar-appeared").css({
            ...
            init: function() {
                e.length && e.each(function() {
                    var e = C(this),
                        ...
                        d = "",
                        n = 0;
                    o = e.offset().top, i = e.position().top, l = s = 0, t.length ? (s = t.outerHeight(), l = t.outerWidth(), n = (d = t).parent().parent().outerHeight(), (t = t.parent().parent().find(".edgtf-blog-holder")).length && (n -= parseInt(t.css("marginBottom")))) : a.length && (s = a.outerHeight(), l = a.outerWidth(), n = (d = a).parents(".vc_row").outerHeight()), c.push({
                        object: e,
                        offset: o,
                        position: i,
                        height: s,
    ...
    function p() {
        ...
        e.length && e.each(function() {
            ...
            t.owlCarousel({
                ...
                dots: y,
                nav: v,
                navText: ['<span class="edgtf-prev-icon">' + f + "</span>", '<span class="edgtf-next-icon">' + f + "</span>"],
                responsive: {
                    0: {
                        items: 1,
                        margin: l,
    ...
    function m() {
        var d, e = C(".edgtf-overlapping-image");
        e.length && (d = "", e.each(function() {
            var e = C(this),
                t = "",
                a = "";
            "" !== e.data("left-mac") && void 0 !== e.data("left-mac") && (t = e.data("left-mac")), "" !== e.data("custom-id") && void 0 !== e.data("custom-id") && (a = e.data("custom-id")), "" !== t && (d += "<style>@media only screen and (min-width: 1200px) and (max-width: 1280px){.wpb_column.edgtf-has-oi .edgtf-overlapping-image." + a + "{left: " + t + "}}</style>")
        }), C("head").append(d))
    }
}(jQuery),
function(f) {
    ...
    function t() {
        var e;
        (e = f(".edgtf-blog-list-holder.edgtf-bl-masonry")).length && e.each(function() {
            var e = f(this).find(".edgtf-blog-list");
    ...
    function n() {
        ...
        function o(a, e) {
            var d, n = a.find(".edgtf-blog-list"),
                e = (void 0 !== a.data("max-num-pages") && !1 !== a.data("max-num-pages") && (d = a.data("max-num-pages")), a.hasClass("edgtf-bl-pag-standard-blog-list") && a.data("next-page", e), a.hasClass("edgtf-bl-pag-infinite-scroll") && a.addClass("edgtf-bl-pag-infinite-scroll-started"), edgtf.modules.common.getLoadMoreData(a)),
                o = a.find(".edgtf-blog-pag-loading"),
                i = e.nextPage,
                t = a.find('input[name*="edgtf_blog_load_more_nonce_"]');
            e.blog_load_more_id = t.attr("name").substring(t.attr("name").length - 4, t.attr("name").length), e.blog_load_more_nonce = t.val(), i <= d && (a.hasClass("edgtf-bl-pag-standard-blog-list") ? (o.addClass("edgtf-showing edgtf-standard-pag-trigger"), a.addClass("edgtf-bl-pag-standard-blog-list-animate")) : o.addClass("edgtf-showing"), t = edgtf.modules.common.setLoadMoreAjaxData(e, "dishup_edge_blog_shortcode_load_more"), f.ajax({
                type: "POST",
                data: t,
                url: edgtfGlobalVars.vars.edgtfAjaxUrl,
                success: function(e) {
                    a.hasClass("edgtf-bl-pag-standard-blog-list") || i++, a.data("next-page", i);
                    var t = f.parseJSON(e).html;
                    a.hasClass("edgtf-bl-pag-standard-blog-list") ? (s(a, d, i), a.waitForImages(function() {
                        a.hasClass("edgtf-bl-masonry") ? r(a, n, o, t) : (l(a, n, o, t), "function" == typeof edgtf.modules.common.edgtfStickySidebarWidget && edgtf.modules.common.edgtfStickySidebarWidget().reInit())
                    })) : a.waitForImages(function() {
                        a.hasClass("edgtf-bl-masonry") ? c(n, o, t) : (g(n, o, t), "function" == typeof edgtf.modules.common.edgtfStickySidebarWidget && edgtf.modules.common.edgtfStickySidebarWidget().reInit())
                    }), a.hasClass("edgtf-bl-pag-infinite-scroll-started") && a.removeClass("edgtf-bl-pag-infinite-scroll-started")
                }
            })), i === d && a.find(".edgtf-blog-pag-load-more").hide()
        }
        var e = f(".edgtf-blog-list-holder"),
            s = function(e, t, a) {
                var e = e.find(".edgtf-bl-standard-pagination"),
                    d = e.find("li.edgtf-bl-pag-number"),
                    n = e.find("li.edgtf-bl-pag-prev a"),
                    e = e.find("li.edgtf-bl-pag-next a");
                d.removeClass("edgtf-bl-pag-active"), d.eq(a - 1).addClass("edgtf-bl-pag-active"), n.data("paged", a - 1), e.data("paged", a + 1), 1 < a ? n.css({
                    opacity: "1"
                }) : n.css({
                    opacity: "0"
                }), a === t ? e.css({
    ...
    }(edgtf.modules.blogListSC = e).edgtfOnDocumentReady = t, e.edgtfOnWindowLoad = a, e.edgtfOnWindowScroll = d, f(document).ready(t), f(window).on("load", a), f(window).scroll(d)
}(jQuery),
function(a) {
    "use strict";
    var e = {};
    ...
    function t() {
        d(), a(document.body).on("blog_list_load_more_trigger", function() {
            d()
        })
    }

    function d() {
        var e = a(".edgtf-blog-holder.edgtf-blog-chequered"),
            t = e.children(".edgtf-blog-holder-inner");
        e.length && (e = t.find(".edgtf-blog-masonry-grid-sizer").outerWidth(), t.children("article").css({
            height: e + "px"
        }), t.isotope("layout", function() {
            t.css("opacity", "1")
        }))
    }(edgtf.modules.blogChequered = e).edgtfOnWindowLoad = t, a(window).on("load", t)
}(jQuery),
function(n) {
    "use strict";
    var e = {};
    ...
    function t() {
        o(), n(document.body).on("blog_list_load_more_trigger", function() {
            i()
        })
    }
    ...
    function o() {
        ...
        e.length && e.each(function() {
            var e = n(this).children(".edgtf-blog-holder-inner"),
                t = e.find("article"),
                a = 1.25 * e.find(".edgtf-blog-masonry-grid-sizer").width();
            t.css({
                height: a + "px"
            }), e.isotope("layout", function() {}), i()
        })
    }
    ...
    }(edgtf.modules.blogMasonryGallery = e).edgtfOnDocumentReady = t, e.edgtfOnWindowLoad = a, e.edgtfOnWindowResize = d, n(document).ready(t), n(window).on("load", a), n(window).resize(d)
}(jQuery),
function(d) {
    "use strict";
    var e = {};
    ...
    }(edgtf.modules.blogNarrow = e).edgtfOnWindowLoad = t, d(window).on("load", t)
}(jQuery),
function(l) {
    "use strict";
    var e = {};
    ...
    function g(e, t) {
        var a, d, n, o;
        t.hasClass("edgtf-masonry-images-fixed") && (a = parseInt(t.find("article").css("padding-left")), d = t.find(".edgtf-post-size-default"), n = t.find(".edgtf-post-size-large-width"), o = t.find(".edgtf-post-size-large-height"), t = t.find(".edgtf-post-size-large-width-height"), 680 < edgtf.windowWidth ? (d.css("height", e - 2 * a), o.css("height", Math.round(2 * e) - 2 * a), t.css("height", Math.round(2 * e) - 2 * a), n.css("height", e - 2 * a)) : (d.css("height", e), o.css("height", e), t.css("height", e), n.css("height", Math.round(e / 2))))
    }
    ...
    function i() {
        ...
        function d(a) {
            var e, d = a.children(".edgtf-blog-holder-inner"),
                t = (void 0 !== a.data("max-num-pages") && !1 !== a.data("max-num-pages") && (e = a.data("max-num-pages")), a.hasClass("edgtf-blog-pagination-infinite-scroll") && a.addClass("edgtf-blog-pagination-infinite-scroll-started"), edgtf.modules.common.getLoadMoreData(a)),
                n = a.find(".edgtf-blog-pag-loading"),
                o = t.nextPage,
                i = a.find('input[name*="edgtf_blog_load_more_nonce_"]');
            t.blog_load_more_id = i.attr("name").substring(i.attr("name").length - 4, i.attr("name").length), t.blog_load_more_nonce = i.val(), o <= e && (n.addClass("edgtf-showing"), i = edgtf.modules.common.setLoadMoreAjaxData(t, "dishup_edge_blog_load_more"), l.ajax({
                type: "POST",
                data: i,
                url: edgtfGlobalVars.vars.edgtfAjaxUrl,
                success: function(e) {
                    ...
                    a.waitForImages(function() {
                        a.hasClass("edgtf-blog-type-masonry") ? (s(d, n, t), g(d.find(".edgtf-blog-masonry-grid-sizer").width(), a)) : r(d, n, t), setTimeout(function() {
    ...
    }(edgtf.modules.blog = e).edgtfOnDocumentReady = t, e.edgtfOnWindowLoad = a, e.edgtfOnWindowResize = d, e.edgtfOnWindowScroll = n, l(document).ready(t), l(window).on("load", a), l(window).resize(d), l(window).scroll(n)
}(jQuery),
function(h) {
    "use strict";
    var e = {};
    ...
    function d() {
        var t, a, d, n, o, i, s, r, l, c, g, f;
        edgtf.body.hasClass("edgtf-header-divided") && (t = h(".edgtf-menu-area"), a = t.width(), d = h(".edgtf-main-menu > ul > li > a"), n = 0, o = t.find(".edgtf-logo-wrapper .edgtf-normal-logo"), i = 0, s = h(".edgtf-sticky-header"), r = s.width(), l = h(".edgtf-sticky-header .edgtf-main-menu > ul > li > a"), c = 0, g = s.find(".edgtf-logo-wrapper .edgtf-normal-logo"), f = 0, t.waitForImages(function() {
            t.children(".edgtf-grid").length && (a = t.children(".edgtf-grid").outerWidth()), d.length && (n = parseInt(d.css("padding-left"))), o.length && (i = o.width() / 2);
            var e = Math.round(a / 2 - n - i);
            h(".edgtf-menu-area .edgtf-position-left").width(e), h(".edgtf-menu-area .edgtf-position-right").width(e), t.css("opacity", 1), "function" == typeof edgtf.modules.header.edgtfSetDropDownMenuPosition && edgtf.modules.header.edgtfSetDropDownMenuPosition(), "function" == typeof edgtf.modules.header.edgtfSetDropDownWideMenuPosition && edgtf.modules.header.edgtfSetDropDownWideMenuPosition()
        }), s.waitForImages(function() {
            s.find(".edgtf-grid").length && (r = s.find(".edgtf-grid").outerWidth()), l.length && (c = parseInt(l.css("padding-left"))), g.length && (f = g.width() / 2);
            var e = Math.round(r / 2 - c - f);
            h(".edgtf-sticky-header .edgtf-position-left").width(e), h(".edgtf-sticky-header .edgtf-position-right").width(e), s.css("opacity", 1), "function" == typeof edgtf.modules.header.edgtfSetDropDownMenuPosition && edgtf.modules.header.edgtfSetDropDownMenuPosition(), "function" == typeof edgtf.modules.header.edgtfSetDropDownWideMenuPosition && edgtf.modules.header.edgtfSetDropDownWideMenuPosition()
        }))
    }(edgtf.modules.headerDivided = e).edgtfOnDocumentReady = t, e.edgtfOnWindowResize = a, h(document).ready(t), h(window).resize(a)
}(jQuery),
function(o) {
    "use strict";
    var e = {};
    ...
    function d() {
        var e, t, a, d, n;
        edgtf.body.hasClass("edgtf-header-divided-boxed") && (e = o(".edgtf-menu-area"), t = e.width(), a = o(".edgtf-main-menu > ul > li > a"), d = 0, n = e.find(".edgtf-logo-wrapper .edgtf-normal-logo"), e.waitForImages(function() {
            e.children(".edgtf-grid").length && (t = e.children(".edgtf-grid").outerWidth()), a.length && (d = parseInt(a.css("padding-left"))), n.length && n.width();
            Math.round(t / 2 - d);
            e.css("opacity", 1), "function" == typeof edgtf.modules.header.edgtfSetDropDownMenuPosition && edgtf.modules.header.edgtfSetDropDownMenuPosition(), "function" == typeof edgtf.modules.header.edgtfSetDropDownWideMenuPosition && edgtf.modules.header.edgtfSetDropDownWideMenuPosition()
        }))
    }(edgtf.modules.headerDividedBoxed = e).edgtfOnDocumentReady = t, e.edgtfOnWindowResize = a, o(document).ready(t), o(window).resize(a)
}(jQuery),
function(c) {
    "use strict";
    var e = {};
    ...
    function t() {
        var e, t, a, d, n, o, i, s, r, l = c("a.edgtf-fullscreen-menu-opener");
        l.length && (e = c(".edgtf-fullscreen-menu-holder-outer"), d = a = !1, n = c(".edgtf-fullscreen-above-menu-widget-holder"), o = c(".edgtf-fullscreen-below-menu-widget-holder"), i = c(".edgtf-fullscreen-menu-holder-outer nav > ul > li > a"), s = c(".edgtf-fullscreen-menu > ul li.has_sub > a"), r = c(".edgtf-fullscreen-menu ul li:not(.has_sub) a"), e.perfectScrollbar({
            wheelSpeed: .6,
            suppressScrollX: !0
        }), c(window).resize(function() {
            e.height(edgtf.windowHeight)
        }), edgtf.body.hasClass("edgtf-fade-push-text-right") ? (t = "edgtf-push-nav-right", a = !0) : edgtf.body.hasClass("edgtf-fade-push-text-top") && (t = "edgtf-push-text-top", d = !0), (a || d) && (n.length && n.children().css({
            ...
            e.preventDefault(), l.hasClass("edgtf-fm-opened") ? (l.removeClass("edgtf-fm-opened"), edgtf.body.removeClass("edgtf-fullscreen-menu-opened edgtf-fullscreen-fade-in").addClass("edgtf-fullscreen-fade-out"), edgtf.body.addClass(t), edgtf.modules.common.edgtfEnableScroll(), c("nav.edgtf-fullscreen-menu ul.sub_menu").slideUp(200)) : (l.addClass("edgtf-fm-opened"), edgtf.body.removeClass("edgtf-fullscreen-fade-out").addClass("edgtf-fullscreen-menu-opened edgtf-fullscreen-fade-in"), edgtf.body.removeClass(t), edgtf.modules.common.edgtfDisableScroll(), c(document).keyup(function(e) {
                27 == e.keyCode && (l.removeClass("edgtf-fm-opened"), edgtf.body.removeClass("edgtf-fullscreen-menu-opened edgtf-fullscreen-fade-in").addClass("edgtf-fullscreen-fade-out"), edgtf.body.addClass(t), edgtf.modules.common.edgtfEnableScroll(), c("nav.edgtf-fullscreen-menu ul.sub_menu").slideUp(200))
            }))
        }), s.on("tap click", function(e) {
            e.preventDefault();
            var t, e = c(this).parent(),
            ...
            1 == e.which && (l.removeClass("edgtf-fm-opened"), edgtf.body.removeClass("edgtf-fullscreen-menu-opened"), edgtf.body.removeClass("edgtf-fullscreen-fade-in").addClass("edgtf-fullscreen-fade-out"), edgtf.body.addClass(t), c("nav.edgtf-fullscreen-menu ul.sub_menu").slideUp(200), edgtf.modules.common.edgtfEnableScroll())
        }))
    }(edgtf.modules.headerMinimal = e).edgtfOnDocumentReady = t, c(document).ready(t)
}(jQuery),
function(i) {
    "use strict";
    var e = {};
    ...
    var a = function() {
        function t() {
            n.hasClass("edgtf-with-scroll") && n.perfectScrollbar({
                wheelSpeed: .6,
                suppressScrollX: !0
            })
        }
        ...
        function a() {
            var e = i(".edgtf-vertical-area-bottom-logo"),
                t = n.find(".edgtf-vertical-area-opener"),
                a = 0;

            function d() {
                n.removeClass("active"), e.length && e.removeClass("active")
            }
            t.on("click tap", function() {
                n.hasClass("active") ? d() : (n.addClass("active"), e.length && e.addClass("active"), a = i(window).scrollTop())
            }), i(window).scroll(function() {
                400 < Math.abs(i(window).scrollTop() - a) && d()
            })
        }
        ...
        return {
            init: function() {
                var o, e;
                n.length && (e = n.find(".edgtf-vertical-menu"), (o = e.find("ul li.menu-item-has-children")).each(function() {
                    var t = i(this).find(" > .second, > ul"),
                        a = this,
                        d = i(this).find("> a"),
                        n = "fast";
                    d.on("click tap", function(e) {
                        e.preventDefault(), e.stopPropagation(), t.is(":visible") ? (i(a).removeClass("open"), t.slideUp(n)) : (d.parent().parent().children().hasClass("open") && d.parent().parent().parent().hasClass("edgtf-vertical-menu") ? (i(this).parent().parent().children().removeClass("open"), i(this).parent().parent().children().find(" > .second").slideUp(n)) : (i(this).parents("li").hasClass("open") || (o.removeClass("open"), o.find(" > .second, > ul").slideUp(n)), i(this).parent().parent().children().hasClass("open") && (i(this).parent().parent().children().removeClass("open"), i(this).parent().parent().children().find(" > .second, > ul").slideUp(n))), i(a).addClass("open"), t.slideDown("slow"))
                    })
                }), t(), edgtf.body.hasClass("edgtf-header-vertical-closed") && a())
            }
        }
    }
}(jQuery),
function(r) {
    ...
    function t() {
        var t, a, d, n = r(".edgtf-mobile-header .edgtf-mobile-menu-opener"),
            o = r(".edgtf-mobile-header .edgtf-mobile-nav"),
            e = r(".edgtf-mobile-nav .mobile_arrow, .edgtf-mobile-nav h6, .edgtf-mobile-nav a.edgtf-mobile-no-link"),
            i = (n.length && o.length && n.on("tap click", function(e) {
                e.stopPropagation(), e.preventDefault(), o.is(":visible") ? (o.slideUp(450, "easeInOutQuint"), n.removeClass("edgtf-mobile-menu-opened")) : (o.slideDown(450, "easeInOutQuint"), n.addClass("edgtf-mobile-menu-opened"))
            }), e.length && e.each(function() {
                var n = r(this);
                n.on("tap click", function(e) {
                    var t, a = n.parent("li"),
                        d = a.siblings(".menu-item-has-children");
                    a.hasClass("has_sub") && ((t = a.find("> ul.sub_menu")).is(":visible") ? (t.slideUp(450, "easeInOutQuint"), a.removeClass("edgtf-opened")) : (a.addClass("edgtf-opened"), (0 === d.length ? a : a.siblings().removeClass("edgtf-opened")).find(".sub_menu").slideUp(400, "easeInOutQuint", function() {
                        t.slideDown(400, "easeInOutQuint")
                    })))
                })
            }), r(".edgtf-mobile-nav a, .edgtf-mobile-logo-wrapper a").on("click tap", function(e) {
                "http://#" !== r(this).attr("href") && "#" !== r(this).attr("href") && (o.slideUp(450, "easeInOutQuint"), n.removeClass("edgtf-mobile-menu-opened"))
            }), l(), r(".edgtf-mobile-header")),
            s = i.find(".edgtf-mobile-menu-opener"),
            e = i.length ? i.outerHeight() : 0;
        edgtf.body.hasClass("edgtf-content-is-behind-header") && 0 < e && edgtf.windowWidth <= 1024 && r(".edgtf-content").css("marginTop", -e), edgtf.body.hasClass("edgtf-sticky-up-mobile-header") && (a = r("#wpadminbar"), d = r(document).scrollTop(), t = e + edgtfGlobalVars.vars.edgtfAddForAdminBar, r(window).scroll(function() {
            var e = r(document).scrollTop();
            t < e ? i.addClass("edgtf-animate-mobile-header") : i.removeClass("edgtf-animate-mobile-header"), d < e && t < e && !s.hasClass("edgtf-mobile-menu-opened") || e < t ? (i.removeClass("mobile-header-appear"), i.css("margin-bottom", 0), a.length && i.find(".edgtf-mobile-header-inner").css("top", 0)) : (i.addClass("mobile-header-appear"), i.css("margin-bottom", t)), d = r(document).scrollTop()
        }))
    }
    ...
    function l() {
        var e, t, a, d;
        edgtf.windowWidth <= 1024 && (e = (t = r(".edgtf-mobile-header")).length ? t.height() : 0, a = (t = t.find(".edgtf-mobile-nav")).outerHeight(), d = edgtf.windowHeight - 100, t.height(d < e + a ? d - e : a).perfectScrollbar({
            wheelSpeed: .6,
            suppressScrollX: !0
        }))
    }(edgtf.modules.mobileHeader = e).edgtfOnDocumentReady = t, e.edgtfOnWindowResize = a, r(document).ready(t), r(window).resize(a)
}(jQuery),
function(f) {
    "use strict";
    var e = {};
    ...
    function t() {
        if (1024 < edgtf.windowWidth) {
            var t, e, a = f(".edgtf-page-header"),
                ...
                n = f(".edgtf-fixed-wrapper"),
                o = n.children(".edgtf-menu-area"),
                i = o.outerHeight(),
                s = f(".edgtf-slider"),
                r = s.length ? s.outerHeight() : 0,
                l = n.length ? n.offset().top - edgtfGlobalVars.vars.edgtfAddForAdminBar : 0;
            switch (!0) {
                case edgtf.body.hasClass("edgtf-sticky-header-on-scroll-up"):
                    edgtf.modules.stickyHeader.behaviour = "edgtf-sticky-header-on-scroll-up";
                    var c = f(document).scrollTop();
                    t = parseInt(edgtfGlobalVars.vars.edgtfTopBarHeight) + parseInt(edgtfGlobalVars.vars.edgtfLogoAreaHeight) + parseInt(edgtfGlobalVars.vars.edgtfMenuAreaHeight) + parseInt(edgtfGlobalVars.vars.edgtfStickyHeaderHeight), (e = function() {
                        ...
                        c < e && t < e || e < t ? (edgtf.modules.stickyHeader.isStickyVisible = !1, d.removeClass("header-appear").find(".edgtf-main-menu .second").removeClass("edgtf-drop-down-start"), edgtf.body.removeClass("edgtf-sticky-header-appear")) : (edgtf.modules.stickyHeader.isStickyVisible = !0, d.addClass("header-appear"), edgtf.body.addClass("edgtf-sticky-header-appear")), c = f(document).scrollTop()
                ...
                case edgtf.body.hasClass("edgtf-fixed-on-scroll"):
                    ...
                    var g = function() {
                        edgtf.scroll <= l ? (n.removeClass("fixed"), edgtf.body.removeClass("edgtf-fixed-header-appear"), o.css({
                            height: i + "px"
                        }), a.css("margin-bottom", "0")) : (n.addClass("fixed"), edgtf.body.addClass("edgtf-fixed-header-appear"), o.css({
                            height: i - 30 + "px"
                        }), a.css("margin-bottom", i - 30 + "px"))
                    };
                    g(), f(window).scroll(function() {
                        g()
                    })
            }
        }
...
function(r) {
    ...
    function t() {
        ...
        d(), (n = r(".edgtf-drop-down > ul > li")).each(function(e) {
            var t, a, d;
            0 < r(n[e]).find(".second").length && (t = r(n[e]), a = t.find(".second"), t.hasClass("wide") && (d = 0, (e = r(this).find(".second > .inner > ul > li")).each(function() {
                var e = r(this).height();
                d < e && (d = e)
            }), e.css("height", ""), e.height(d)), edgtf.menuDropdownHeightSet || (t.data("original_height", a.height() + "px"), a.height(0)), navigator.userAgent.match(/(iPod|iPhone|iPad)/) ? t.on("touchstart mouseenter", function() {
                a.css({
            ...
            }) : edgtf.body.hasClass("edgtf-dropdown-animate-height") ? t.mouseenter(function() {
                a.css({
                    visibility: "visible",
                    height: "0px",
                    opacity: "0"
    ...
    function d() {
        ...
        e.length && e.each(function(e) {
            ...
            edgtf.body.hasClass("edgtf-boxed") && (s = edgtf.boxedLayoutWidth - (d - (edgtf.windowWidth - edgtf.boxedLayoutWidth) / 2)), 0 < a.find("li.sub").length && (t = s - i), n.removeClass("right"), o.removeClass("right"), (s < i || t < i) && (n.addClass("right"), o.addClass("right"))
        })
    }

    function n() {
        var d = r(".edgtf-drop-down > ul > li.wide");
        d.length && d.each(function(e) {
            var t, a, e = r(d[e]).find(".second");
            !e.length || e.hasClass("left_position") || e.hasClass("right_position") || (e.css("left", 0), t = e.offset().left, edgtf.body.hasClass("edgtf-boxed") ? (a = r(".edgtf-boxed .edgtf-wrapper .edgtf-wrapper-inner").outerWidth(), t -= (edgtf.windowWidth - a) / 2, e.css("left", -t), e.css("width", a)) : (e.css("left", -t), e.css("width", edgtf.windowWidth)))
        })
    }(edgtf.modules.header = e).edgtfSetDropDownMenuPosition = d, e.edgtfSetDropDownWideMenuPosition = n, e.edgtfOnDocumentReady = t, e.edgtfOnWindowLoad = a, r(document).ready(t), r(window).on("load", a)
}(jQuery),
function(t) {
    "use strict";
    var e = {};
    ...
    }(edgtf.modules.reservationDatePicker = e).edgtfReservationDatePicker = d, e.edgtfOnDocumentReady = a, t(document).ready(a)
}(jQuery),
function(c) {
    "use strict";
    var e = {};
    ...
    function t() {
        var e;
        edgtf.body.hasClass("edgtf-search-covers-header") && 0 < (e = c("a.edgtf-search-opener")).length && e.on("click", function(e) {
            e.preventDefault();
            var t, e = c(this),
                a = c(".edgtf-page-header"),
                d = c(".edgtf-top-bar"),
                n = a.find(".edgtf-fixed-wrapper.fixed"),
                o = c(".edgtf-mobile-header"),
                i = c(".edgtf-search-cover"),
                s = !!e.parents(".edgtf-top-bar").length,
                r = !!e.parents(".edgtf-fixed-wrapper.fixed").length,
                l = !!e.parents(".edgtf-sticky-header").length,
                e = !!e.parents(".edgtf-mobile-header").length;
            i.removeClass("edgtf-is-active"), s ? (t = edgtfGlobalVars.vars.edgtfTopBarHeight, d.find(".edgtf-search-cover").addClass("edgtf-is-active")) : r ? (t = n.outerHeight(), a.children(".edgtf-search-cover").addClass("edgtf-is-active")) : l ? (t = edgtfGlobalVars.vars.edgtfStickyHeaderHeight, a.children(".edgtf-search-cover").addClass("edgtf-is-active")) : e ? (t = (o.hasClass("mobile-header-appear") ? o.children(".edgtf-mobile-header-inner") : o).outerHeight(), o.find(".edgtf-search-cover").addClass("edgtf-is-active")) : (t = a.outerHeight(), a.children(".edgtf-search-cover").addClass("edgtf-is-active")), i.hasClass("edgtf-is-active") && i.height(t).stop(!0).fadeIn(600).find('input[type="text"]').focus(), i.find(".edgtf-search-close").on("click", function(e) {
...
function(n) {
    ...
    function t() {
        var a, t, e, d;
        edgtf.body.hasClass("edgtf-fullscreen-search") && 0 < (e = n("a.edgtf-search-opener")).length && (a = n(".edgtf-fullscreen-search-holder"), t = n(".edgtf-fullscreen-search-close"), e.on("click", function(e) {
        ...
        }), e = n(".edgtf-fullscreen-search-holder .edgtf-search-field"), d = n(".edgtf-fullscreen-search-holder .edgtf-field-holder .edgtf-line"), e.focus(function() {
            d.css("width", "100%")
        }), e.blur(function() {
            d.css("width", "0")
        }))
...
function(g) {
    ...
    function t() {
        ...
        edgtf.body.hasClass("edgtf-slide-from-header-bottom") && 0 < (e = g("a.edgtf-search-opener")).length && e.on("click", function(e) {
            e.preventDefault();
            var e = g(this),
                t = parseInt(edgtf.windowWidth - e.offset().left - e.outerWidth()),
                a = (edgtf.body.hasClass("edgtf-boxed") && 1024 < edgtf.windowWidth && (t -= parseInt((edgtf.windowWidth - g(".edgtf-boxed .edgtf-wrapper .edgtf-wrapper-inner").outerWidth()) / 2)), g(".edgtf-page-header")),
                d = "100%",
                n = g(".edgtf-top-bar"),
                o = a.find(".edgtf-fixed-wrapper.fixed"),
                i = g(".edgtf-mobile-header"),
                s = g(".edgtf-slide-from-header-bottom-holder"),
                r = !!e.parents(".edgtf-top-bar").length,
                l = !!e.parents(".edgtf-fixed-wrapper.fixed").length,
                c = !!e.parents(".edgtf-sticky-header").length,
                e = !!e.parents(".edgtf-mobile-header").length;
            s.removeClass("edgtf-is-active"), r ? n.find(".edgtf-slide-from-header-bottom-holder").addClass("edgtf-is-active") : l ? (d = o.outerHeight() + edgtfGlobalVars.vars.edgtfAddForAdminBar, a.children(".edgtf-slide-from-header-bottom-holder").addClass("edgtf-is-active")) : c ? (d = edgtfGlobalVars.vars.edgtfStickyHeaderHeight + edgtfGlobalVars.vars.edgtfAddForAdminBar, a.children(".edgtf-slide-from-header-bottom-holder").addClass("edgtf-is-active")) : e ? (i.hasClass("mobile-header-appear") && (d = i.children(".edgtf-mobile-header-inner").outerHeight() + edgtfGlobalVars.vars.edgtfAddForAdminBar), i.find(".edgtf-slide-from-header-bottom-holder").addClass("edgtf-is-active")) : a.children(".edgtf-slide-from-header-bottom-holder").addClass("edgtf-is-active"), s.hasClass("edgtf-is-active") && s.css({
                right: t,
                top: d
...
function(d) {
    ...
    function t() {
        var e, t, a;
        edgtf.body.hasClass("edgtf-search-slides-from-window-top") && 0 < (e = d("a.edgtf-search-opener")).length && (t = d(".edgtf-search-slide-window-top"), a = d(".edgtf-swt-search-close"), e.on("click", function(e) {
...
function(n) {
    ...
    function t() {
        var a, d, e;
        e = n(".edgtf-wrapper"), a = n("a.edgtf-side-menu-button-opener"), d = "edgtf-right-side-menu-opened", e.prepend('<div class="edgtf-cover"/>'), n("a.edgtf-side-menu-button-opener, a.edgtf-close-side-menu").on("click", function(e) {
            var t;
            e.preventDefault(), a.hasClass("opened") ? (a.removeClass("opened"), edgtf.body.removeClass(d)) : (a.addClass("opened"), edgtf.body.addClass(d), n(".edgtf-wrapper .edgtf-cover").on("click", function() {
                edgtf.body.removeClass("edgtf-right-side-menu-opened"), a.removeClass("opened")
            }), t = n(window).scrollTop(), n(window).scroll(function() {
                400 < Math.abs(edgtf.scroll - t) && (edgtf.body.removeClass(d), a.removeClass("opened"))
            }))
        }), (e = n(".edgtf-side-menu")).length && e.perfectScrollbar({
            wheelSpeed: .6,
            suppressScrollX: !0
        })
    }(edgtf.modules.sidearea = e).edgtfOnDocumentReady = t, n(document).ready(t)
}(jQuery),
function(s) {
    "use strict";
    var e = {};
    ...
    function t() {
        var e, t, a, d, n, o, i = s(".edgtf-title-holder.edgtf-bg-parallax");
        0 < i.length && 1024 < edgtf.windowWidth && (e = i.hasClass("edgtf-bg-parallax-zoom-out"), t = parseInt(i.data("height")), a = parseInt(i.data("background-width")), d = t / 1e4 * 7, n = -edgtf.scroll * d, o = edgtfGlobalVars.vars.edgtfAddForAdminBar, i.css({
            "background-position": "center " + (n + o) + "px"
        }), e && i.css({
            "background-size": a - edgtf.scroll + "px auto"
        }), s(window).scroll(function() {
            n = -edgtf.scroll * d, i.css({
                "background-position": "center " + (n + o) + "px"
            }), e && i.css({
                "background-size": a - edgtf.scroll + "px auto"
            })
...
function(s) {
    ...
    function t() {
        s(document).on("click", ".edgtf-quantity-minus, .edgtf-quantity-plus", function(e) {
            e.stopPropagation();
            var t, e = s(this),
                a = e.siblings(".edgtf-quantity-input"),
                d = parseFloat(a.data("step")),
                n = parseFloat(a.data("max")),
                o = !1,
                i = parseFloat(a.val());
            (o = e.hasClass("edgtf-quantity-minus") ? !0 : o) ? 1 <= (t = i - d) ? a.val(t) : a.val(0): (t = i + d, void 0 !== n && n <= t ? a.val(n) : a.val(t)), a.trigger("change")
        });
        var e = s(".woocommerce-ordering .orderby");
        e.length && e.select2({
            minimumResultsForSearch: 1 / 0
        }), (e = s(".edgtf-woocommerce-page .edgtf-content .variations td.value select")).length && e.select2(), (e = s("#calc_shipping_country")).length && e.select2(), (e = s(".cart-collaterals .shipping select#calc_shipping_state")).length && e.select2(), (e = s(".edgtf-woo-single-page.edgtf-woo-single-has-pretty-photo .images .woocommerce-product-gallery__image")).length && (e.children("a").attr("data-rel", "prettyPhoto[woo_single_pretty_photo]"), "function" == typeof edgtf.modules.common.edgtfPrettyPhoto && edgtf.modules.common.edgtfPrettyPhoto())
    }
    ...
    function n() {
        var e = s(".edgtf-pl-holder.edgtf-masonry-layout .edgtf-pl-outer");
        e.length && e.each(function() {
            var e = s(this);
            e.waitForImages(function() {
                e.isotope({
    ...
    }(edgtf.modules.woocommerce = e).edgtfOnDocumentReady = t, e.edgtfOnWindowLoad = a, e.edgtfOnWindowResize = d, s(document).ready(t), s(window).on("load", a), s(window).resize(d)
}(jQuery),
function(t) {
    "use strict";
    var e = {};
    ...
    function a() {
        ...
        e.length && e.each(function() {
            ...
            a.hasClass("edgtf-accordion") && a.accordion({
                ...
                icons: "",
                heightStyle: "content"
            }), a.hasClass("edgtf-toggle") && (t = (e = (a = d(this)).find(".edgtf-accordion-title")).next(), a.addClass("accordion ui-accordion ui-accordion-icons ui-widget ui-helper-reset"), e.addClass("ui-accordion-header ui-state-default ui-corner-top ui-corner-bottom"), t.addClass("ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom").hide(), e.each(function() {
                var e = d(this);
...
function(n) {
    ...
    function a() {
        var e = n(".edgtf-grow-in, .edgtf-fade-in-down, .edgtf-element-from-fade, .edgtf-element-from-left, .edgtf-element-from-right, .edgtf-element-from-top, .edgtf-element-from-bottom, .edgtf-flip-in, .edgtf-x-rotate, .edgtf-z-rotate, .edgtf-y-translate, .edgtf-fade-in, .edgtf-fade-in-left-x-rotate");
        e.length && e.each(function() {
            var t = n(this),
                a = t.data("animation"),
                d = parseInt(t.data("animation-delay"));
            t.hasClass("edgtf-animation-on-load") ? n(window).on("load", function() {
                var e;
                void 0 !== a && "" !== a && (e = a + "-on", setTimeout(function() {
                    t.addClass(e)
                }, d))
            }) : t.appear(function() {
                var e;
...
function(s) {
    ...
    function t() {
        a().init()
    }(edgtf.modules.button = e).edgtfButton = a, e.edgtfOnDocumentReady = t, s(document).ready(t);
    var a = function() {
        var e = s(".edgtf-btn");
        return {
            init: function() {
                e.length && e.each(function() {
                    var e, t, a, d, n, o, i;
                    void 0 !== (d = s(this)).data("hover-color") && (a = function(e) {
                        e.data.button.css("color", e.data.color)
                    }, t = d.css("color"), e = d.data("hover-color"), d.on("mouseenter", {
                        button: d,
                        color: e
                    }, a), d.on("mouseleave", {
                        button: d,
                        color: t
                    }, a)), void 0 !== (e = s(this)).data("hover-bg-color") && (d = function(e) {
                        ...
                        button: e,
                        color: t
                    }, d)), void 0 !== (d = s(this)).data("hover-border-color") && (n = function(e) {
                        e.data.button.css("border-color", e.data.color)
                    }, o = d.css("borderTopColor"), i = d.data("hover-border-color"), d.on("mouseenter", {
                        button: d,
                        color: i
                    }, n), d.on("mouseleave", {
                        button: d,
...
function(v) {
    ...
    function a() {
        var n, o, i, s, r, l, c, g, f, h, u, e = v(".edgtf-countdown"),
            t = new Date,
            p = t.getMonth(),
            m = t.getFullYear();
        e.length && e.each(function() {
            var e, t, a = v(this).attr("id"),
                d = v("#" + a);
            n = d.data("year"), o = d.data("month"), i = d.data("day"), s = d.data("hour"), r = d.data("minute"), l = d.data("timezone"), c = d.data("month-label"), g = d.data("day-label"), f = d.data("hour-label"), h = d.data("minute-label"), u = d.data("second-label"), e = d.data("digit-size"), t = d.data("label-size"), p === o && m === n || (o -= 1), d.countdown({
                until: new Date(n, o, i, s, r, 44),
                labels: ["", c, "", g, f, h, u],
                format: "ODHMS",
                timezone: l,
                padZeroes: !0,
    ...
    }(edgtf.modules.countdown = e).edgtfInitCountdown = a, e.edgtfOnDocumentReady = t, v(document).ready(t)
}(jQuery),
function(d) {
    "use strict";
    var e = {};
...
function(r) {
    ...
    function d() {
        ...
        e.length && e.each(function() {
            var e = r(this),
                ...
                i = "",
                s = "";
            void 0 !== e.data("item-class") && !1 !== e.data("item-class") && (t = e.data("item-class")), void 0 !== e.data("font-size-1280") && !1 !== e.data("font-size-1280") && (a += "font-size: " + e.data("font-size-1280") + " !important;"), void 0 !== e.data("font-size-1024") && !1 !== e.data("font-size-1024") && (d += "font-size: " + e.data("font-size-1024") + " !important;"), void 0 !== e.data("font-size-768") && !1 !== e.data("font-size-768") && (n += "font-size: " + e.data("font-size-768") + " !important;"), void 0 !== e.data("font-size-680") && !1 !== e.data("font-size-680") && (o += "font-size: " + e.data("font-size-680") + " !important;"), void 0 !== e.data("line-height-1280") && !1 !== e.data("line-height-1280") && (a += "line-height: " + e.data("line-height-1280") + " !important;"), void 0 !== e.data("line-height-1024") && !1 !== e.data("line-height-1024") && (d += "line-height: " + e.data("line-height-1024") + " !important;"), void 0 !== e.data("line-height-768") && !1 !== e.data("line-height-768") && (n += "line-height: " + e.data("line-height-768") + " !important;"), void 0 !== e.data("line-height-680") && !1 !== e.data("line-height-680") && (o += "line-height: " + e.data("line-height-680") + " !important;"), (a.length || d.length || n.length || o.length) && (a.length && (s += "@media only screen and (max-width: 1280px) {.edgtf-custom-font-holder." + t + " { " + a + " } }"), d.length && (s += "@media only screen and (max-width: 1024px) {.edgtf-custom-font-holder." + t + " { " + d + " } }"), n.length && (s += "@media only screen and (max-width: 768px) {.edgtf-custom-font-holder." + t + " { " + n + " } }"), o.length && (s += "@media only screen and (max-width: 680px) {.edgtf-custom-font-holder." + t + " { " + o + " } }")), (i = s.length ? '<style type="text/css">' + s + "</style>" : i).length && r("head").append(i)
        })
    }
    ...
    function n() {
        ...
        e.length && e.each(function() {
            var e = r(this),
                ...
                o = e.find(".edgtf-cf-typed-3").text(),
                i = e.find(".edgtf-cf-typed-4").text();
            d.length && a.push(d), n.length && a.push(n), o.length && a.push(o), i.length && a.push(i), t.appear(function() {
                e.typed({
                    strings: a,
                    typeSpeed: 90,
                    backDelay: 700,
    ...
    }(edgtf.modules.customFont = e).edgtfCustomFontResize = d, e.edgtfCustomFontTypeOut = n, e.edgtfOnDocumentReady = t, e.edgtfOnWindowLoad = a, r(document).ready(t), r(window).on("load", a)
}(jQuery),
function(r) {
    "use strict";
    var e = {};
...
function(g) {
    ...
    function a() {
        ...
        e.length && e.each(function() {
            var d = g(this),
                ...
                s = "",
                r = "",
                l = (edgtf.body.hasClass("edgtf-light-header") ? r = "light" : edgtf.body.hasClass("edgtf-dark-header") && (r = "dark"), void 0 !== d.data("enable-continuous-vertical") && !1 !== d.data("enable-continuous-vertical") && "yes" === d.data("enable-continuous-vertical") && (t = !0), void 0 !== d.data("enable-navigation") && !1 !== d.data("enable-navigation") && (a = d.data("enable-navigation")), void 0 !== d.data("enable-pagination") && !1 !== d.data("enable-pagination") && (s = d.data("enable-pagination")), "no" !== a);
            e.fullpage({
                ...
                onLeave: function(e, t, a) {
                    i && f(g(n[t - 1]).data("header-style"), r), l && h(d, o, t)
                },
                afterRender: function() {
                    i && f(n.first().data("header-style"), r), l && (h(d, o, 1), d.children(".edgtf-fss-nav-holder").css("visibility", "visible")), e.css("visibility", "visible")
                }
            });
            var a = (a = d).find(".edgtf-fss-item"),
                c = "",
                t = "";
            a.each(function() {
                var e = g(this),
    ...
    function h(e, t, a) {
        var d = e,
            n = d.find("#edgtf-fss-nav-up"),
            d = d.find("#edgtf-fss-nav-down"),
            o = !1;
...
function(y) {
    ...
    function a() {
        var e = y(".edgtf-google-map");
        e.length && e.each(function() {
            var e, t, a, d, n, o, i, s = y(this),
                r = !1,
                s = (void 0 !== s.data("predefined-style") && "yes" === s.data("predefined-style") && (r = !0), void 0 !== s.data("custom-map-style") && (a = s.data("custom-map-style")), void 0 !== s.data("color-overlay") && !1 !== s.data("color-overlay") && (d = s.data("color-overlay")), void 0 !== s.data("saturation") && !1 !== s.data("saturation") && (m = s.data("saturation")), void 0 !== s.data("lightness") && !1 !== s.data("lightness") && (v = s.data("lightness")), void 0 !== s.data("zoom") && !1 !== s.data("zoom") && (o = s.data("zoom")), void 0 !== s.data("pin") && !1 !== s.data("pin") && (p = s.data("pin")), void 0 !== s.data("height") && !1 !== s.data("height") && (i = s.data("height")), void 0 !== s.data("unique-id") && !1 !== s.data("unique-id") && (e = s.data("unique-id")), void 0 !== s.data("scroll-wheel") && (n = s.data("scroll-wheel")), void 0 !== s.data("addresses") && !1 !== s.data("addresses") && (t = s.data("addresses")), "map_" + e),
                l = "edgtf-map-" + e,
                c = p,
                g = s,
                f = "geocoder_" + e,
            ...
            if ("object" == typeof google) {
                var u, p = [],
                    ...
                    }], d = r || "yes" === a ? "edgtf-style" : google.maps.MapTypeId.ROADMAP, n = "yes" === n, new google.maps.StyledMapType(p, {
                        name: "Edge Google Map"
                    })),
                    v = (f = new google.maps.Geocoder, new google.maps.LatLng(-34.397, 150.644)),
                    r = (isNaN(i) || (i += "px"), {
                        zoom: o,
                        scrollwheel: n,
                        center: v,
                ...
                for ((g = new google.maps.Map(document.getElementById(l), r)).mapTypes.set("edgtf-style", m), u = 0; u < h.length; ++u) ! function(d, n, o, e) {
                    var t, i;
                    "" !== d && (t = '<div id="content"><div id="siteNotice"></div><div id="bodyContent"><p>' + d + "</p></div></div>", i = new google.maps.InfoWindow({
                        content: t
                    }), e.geocode({
                        address: d
                    }, function(e, t) {
                ...
                document.getElementById(l).style.height = i
            }
        })
    }(edgtf.modules.googleMap = e).edgtfShowGoogleMap = a, e.edgtfOnDocumentReady = t, y(document).ready(t)
}(jQuery),
function(r) {
    "use strict";
    var e = {};
    ...
    function t() {
        a().init()
    }(edgtf.modules.icon = e).edgtfIcon = a, e.edgtfOnDocumentReady = t, r(document).ready(t);
    var a = function() {
        var e = r(".edgtf-icon-shortcode");
        return {
            init: function() {
                e.length && e.each(function() {
                    var e, t, a, d, n, o, i, s;
                    (e = r(this)).hasClass("edgtf-icon-animation") && e.appear(function() {
                        e.parent(".edgtf-icon-animation-holder").addClass("edgtf-icon-animation-show")
                    }, {
                        accX: 0,
                        accY: edgtfGlobalVars.vars.edgtfElementAppearAmount
                    }), void 0 !== (o = r(this)).data("hover-color") && (n = function(e) {
                        e.data.icon.css("color", e.data.color)
                    }, a = o.find(".edgtf-icon-element"), t = o.data("hover-color"), d = a.css("color"), "" !== t && (o.on("mouseenter", {
                        icon: a,
                        color: t
                    }, n), o.on("mouseleave", {
                        icon: a,
                        color: d
                    }, n))), void 0 !== (t = r(this)).data("hover-background-color") && (o = function(e) {
                        e.data.icon.css("background-color", e.data.color)
                    }, a = t.data("hover-background-color"), d = t.css("background-color"), "" !== a && (t.on("mouseenter", {
                        icon: t,
                        color: a
                    }, o), t.on("mouseleave", {
                        icon: t,
                        color: d
                    }, o))), void 0 !== (n = r(this)).data("hover-border-color") && (o = function(e) {
                        e.data.icon.css("border-color", e.data.color)
                    }, i = n.data("hover-border-color"), s = n.css("borderTopColor"), "" !== i && (n.on("mouseenter", {
                        icon: n,
                        color: i
                    }, o), n.on("mouseleave", {
                        icon: n,
...
function(g) {
    ...
    function t() {
        var e;
        (e = g(".edgtf-image-carousel")).length && e.each(function() {
            var e = g(this).children(".edgtf-owl-slider"),
                t = "",
                a = "",
                d = "",
                n = "",
...
function(t) {
    ...
    }(edgtf.modules.imageGallery = e).edgtfInitImageGalleryMasonry = d, e.edgtfOnWindowLoad = a, t(window).on("load", a)
}(jQuery),
function(t) {
    "use strict";
    var e = {};
    ...
    function d() {
        ...
        e.length && e.each(function() {
            var a = t(this),
                ...
                o = "#f7f7f7",
                i = 176;
            void 0 !== d.data("size") && "" !== d.data("size") && (i = d.data("size")), void 0 !== d.data("bar-color") && "" !== d.data("bar-color") && (n = d.data("bar-color")), void 0 !== d.data("track-color") && "" !== d.data("track-color") && (o = d.data("track-color")), d.appear(function() {
                var e, t;
                e = (e = d).find(".edgtf-pc-percent"), t = parseFloat(e.text()), e.countTo({
                    from: 0,
                    to: t,
                    speed: 1500,
                    refreshInterval: 50
...
function(i) {
    ...
    function a() {
        ...
        e.length && e.each(function() {
            var d = i(this),
                n = d.find(".edgtf-pb-content"),
                o = n.data("percentage");
            d.appear(function() {
                var e, t, a;
                e = d, t = o, a = parseFloat(t), (t = e.find(".edgtf-pb-percent")).length && t.each(function() {
                    var e = i(this);
...
function(r) {
    ...
    function a() {
        var e = r(".edgtf-section-title-holder .edgtf-st-title");
        e.length && e.each(function() {
            var e = r(this),
                t = "",
                a = "",
...
function(d) {
    ...
    function a() {
        ...
        e.length && e.each(function() {
            ...
            }), e.tabs(), d(".edgtf-tabs a.edgtf-external-link").off("click")
        })
...
function(o) {
    ...
    function a() {
        function n(e, t) {
            var a = e.find(".edgtf-mg-rectangle-portrait"),
                d = e.find(".edgtf-mg-rectangle-landscape"),
                n = e.find(".edgtf-mg-square-big"),
                o = e.find(".edgtf-mg-square-small"),
                e = void 0 !== (e = e.find(".edgtf-mg-item").css("paddingLeft")) && "" !== e ? parseInt(e, 10) : 0,
                t = t - 2 * e;
            a.css("height", 2 * (t + e)), window.innerWidth <= 680 ? d.css("height", t / 2) : d.css("height", t), n.css("height", 2 * (t + e)), window.innerWidth <= 680 && n.css("height", n.width()), o.css("height", t)
        }
        var e = o(".edgtf-masonry-gallery-holder");
        return {
            init: function() {
                e.length && e.each(function() {
                    var e, t, a = o(this).children(".edgtf-mg-inner"),
                        d = a.children(".edgtf-mg-grid-sizer");
                    t = d, (e = a).waitForImages(function() {
                        e.isotope({
                            layoutMode: "packery",
                        ...
                        }), n(e, t.outerWidth()), setTimeout(function() {
                            e.animate({
                                opacity: 1
                            }).isotope("layout")
                        }, 800)
                        ...
                        var e;
                        n(e = a, d.outerWidth()), e.isotope("reloadItems")
                    })
                })
            }
        }
    }(edgtf.modules.masonryGalleryList = e).edgtfInitMasonryGallery = a, e.edgtfOnDocumentReady = t, o(document).ready(t)
}(jQuery),
function(h) {
    "use strict";
    var e = {};
    ...
    function a() {
        var e;
        o(), (e = h(".edgtf-portfolio-list-holder .edgtf-pl-filter-holder")).length && e.each(function() {
            var n = h(this),
                o = n.closest(".edgtf-portfolio-list-holder"),
                i = o.find(".edgtf-pl-inner"),
                s = !!o.hasClass("edgtf-pl-pag-load-more");
            n.find(".edgtf-pl-filter:first").addClass("edgtf-pl-current"), o.hasClass("edgtf-pl-gallery") && i.isotope(), n.find(".edgtf-pl-filter").on("click", function() {
                var e = h(this),
                    t = e.attr("data-filter"),
                    a = t.length ? t.substring(1) : "",
                    d = !!i.children().hasClass(a);
                e.parent().children(".edgtf-pl-filter").removeClass("edgtf-pl-current"), e.addClass("edgtf-pl-current"), s && !d && t.length ? function a(e, t, d) {
                    var n = e,
                        o = n.find(".edgtf-pl-inner"),
                        i = t,
                        s = d,
                        e = 0;
                    ...
                    var t = edgtf.modules.common.getLoadMoreData(n),
                        r = t.nextPage,
                        d = edgtf.modules.common.setLoadMoreAjaxData(t, "edgtf_core_portfolio_ajax_load_more"),
                        l = n.find(".edgtf-pl-loading");
                    r <= e && (l.addClass("edgtf-showing edgtf-filter-trigger"), o.css("opacity", "0"), h.ajax({
                        type: "POST",
                        data: d,
                        url: edgtfGlobalVars.vars.edgtfAjaxUrl,
                        success: function(e) {
                            ...
                            n.waitForImages(function() {
                                ...
                                e ? setTimeout(function() {
                                    p(o.find(".edgtf-pl-grid-sizer").width(), n), o.isotope("layout").isotope({
                                        filter: i
                                    }), l.removeClass("edgtf-showing edgtf-filter-trigger"), setTimeout(function() {
                                        o.css("opacity", "1"), u(), edgtf.modules.common.edgtfInitParallax()
                                    }, 150)
                                }, 400) : (l.removeClass("edgtf-showing edgtf-filter-trigger"), a(n, i, s))
                            })
                        }
                    }))
                }(o, t, a) : (t = 0 === t.length ? "*" : t, n.parent().children(".edgtf-pl-inner").isotope({
                    filter: t
                }), edgtf.modules.common.edgtfInitParallax())
            })
        }), (e = h(".edgtf-portfolio-single-holder .edgtf-ps-masonry-images").children()).length && (e.isotope({
            layoutMode: "packery",
        ...
        }), e.css("opacity", "1")), u(), i().init(), s().init()
    }
    ...
    function u() {
        var e = h(".edgtf-portfolio-list-holder.edgtf-pl-has-animation");
        e.length && e.each(function() {
            h(this).children(".edgtf-pl-inner").children("article").each(function(e) {
                var t = h(this);
                t.appear(function() {
    ...
    function o() {
        var e = h(".edgtf-portfolio-list-holder.edgtf-pl-masonry");
        e.length && e.each(function() {
            var e = h(this),
    ...
    function p(e, t) {
        var a, d, n, o;
        t.hasClass("edgtf-pl-images-fixed") && (a = parseInt(t.find("article").css("padding-left")), d = t.find(".edgtf-pl-masonry-default"), n = t.find(".edgtf-pl-masonry-large-width"), o = t.find(".edgtf-pl-masonry-large-height"), t = t.find(".edgtf-pl-masonry-large-width-height"), 680 < edgtf.windowWidth ? (d.css("height", e - 2 * a), o.css("height", Math.round(2 * e) - 2 * a), t.css("height", Math.round(2 * e) - 2 * a), n.css("height", e - 2 * a)) : (d.css("height", e), o.css("height", e), t.css("height", e), n.css("height", Math.round(e / 2))))
    }
    ...
    function i() {
        ...
        function o(a, d) {
            var n, o = a.find(".edgtf-pl-inner"),
                e = (void 0 !== a.data("max-num-pages") && !1 !== a.data("max-num-pages") && (n = a.data("max-num-pages")), a.hasClass("edgtf-pl-pag-standard") && a.data("next-page", d), a.hasClass("edgtf-pl-pag-infinite-scroll") && a.addClass("edgtf-pl-infinite-scroll-started"), edgtf.modules.common.getLoadMoreData(a)),
                i = a.find(".edgtf-pl-loading"),
                s = e.nextPage;
            (s <= n || 0 === n) && (a.hasClass("edgtf-pl-pag-standard") ? (i.addClass("edgtf-showing edgtf-standard-pag-trigger"), a.addClass("edgtf-pl-pag-standard-animate")) : i.addClass("edgtf-showing"), e = edgtf.modules.common.setLoadMoreAjaxData(e, "edgtf_core_portfolio_ajax_load_more"), h.ajax({
                type: "POST",
                data: e,
                url: edgtfGlobalVars.vars.edgtfAjaxUrl,
                success: function(e) {
                    a.hasClass("edgtf-pl-pag-standard") || s++, a.data("next-page", s);
                    var t = h.parseJSON(e).html;
                    a.hasClass("edgtf-pl-pag-standard") ? (r(a, n, s), a.waitForImages(function() {
                        (a.hasClass("edgtf-pl-masonry") || a.hasClass("edgtf-pl-gallery") && a.hasClass("edgtf-pl-has-filter") ? l : c)(a, o, i, t)
                    })) : a.waitForImages(function() {
                        a.hasClass("edgtf-pl-masonry") ? (1 == d ? l : g)(a, o, i, t) : a.hasClass("edgtf-pl-gallery") && a.hasClass("edgtf-pl-has-filter") && 1 != d ? g(a, o, i, t) : 1 == d ? c(a, o, i, t) : f(o, i, t)
                    }), a.hasClass("edgtf-pl-infinite-scroll-started") && a.removeClass("edgtf-pl-infinite-scroll-started")
                }
            })), s === n && a.find(".edgtf-pl-load-more-holder").hide()
        }
        var e = h(".edgtf-portfolio-list-holder"),
            r = function(e, t, a) {
                var e = e.find(".edgtf-pl-standard-pagination"),
                    d = e.find("li.edgtf-pl-pag-number"),
                    n = e.find("li.edgtf-pl-pag-prev a"),
                    e = e.find("li.edgtf-pl-pag-next a");
                d.removeClass("edgtf-pl-pag-active"), d.eq(a - 1).addClass("edgtf-pl-pag-active"), n.data("paged", a - 1), e.data("paged", a + 1), 1 < a ? n.css({
                    opacity: "1"
                }) : n.css({
                    opacity: "0"
                }), a === t ? e.css({
            ...
            l = function(e, t, a, d) {
                t.find("article").remove(), t.append(d), p(t.find(".edgtf-pl-grid-sizer").width(), e), t.isotope("reloadItems").isotope({
                    ...
                    t.isotope("layout"), u(), edgtf.modules.common.edgtfInitParallax()
                }, 600)
            },
            c = function(e, t, a, d) {
                a.removeClass("edgtf-showing edgtf-standard-pag-trigger"), e.removeClass("edgtf-pl-pag-standard-animate"), t.html(d), u(), edgtf.modules.common.edgtfInitParallax()
            },
            g = function(e, t, a, d) {
            ...
            f = function(e, t, a) {
                t.removeClass("edgtf-showing"), e.append(a), u(), edgtf.modules.common.edgtfInitParallax()
            };
        return {
            init: function() {
                e.length && e.each(function() {
    ...
    }(edgtf.modules.portfolio = e).edgtfOnDocumentReady = t, e.edgtfOnWindowLoad = a, e.edgtfOnWindowResize = d, e.edgtfOnWindowScroll = n, h(document).ready(t), h(window).on("load", a), h(window).resize(d), h(window).scroll(n);
    var s = function() {
        var t, a, d, e, n, o = h(".edgtf-follow-portfolio-info .edgtf-portfolio-single-holder .edgtf-ps-info-sticky-holder");
        o.length && (e = o.parent(), t = e.offset().top, a = e.height(), d = h(".edgtf-ps-image-holder").height(), e = h(".header-appear, .edgtf-fixed-wrapper"), n = e.length ? e.height() : 0);
        return {
            init: function() {
                var e;
                o.length && a < d && edgtf.scroll > t && (e = edgtf.scroll - t + edgtfGlobalVars.vars.edgtfAddForAdminBar + n, d < e + a && (e = d - a), o.stop().animate({
                    marginTop: e
                })), h(window).scroll(function() {
                    o.length && a < d && (edgtf.scroll > t ? edgtf.scroll + n + edgtfGlobalVars.vars.edgtfAddForAdminBar + a + 50 < t + d ? (h(".header-appear, .edgtf-fixed-wrapper").length && (n = h(".header-appear, .edgtf-fixed-wrapper").height()), o.stop().animate({
                        marginTop: edgtf.scroll - t + edgtfGlobalVars.vars.edgtfAddForAdminBar + n
                    }), n = 0) : o.stop().animate({
                        marginTop: d - a
                    }) : o.stop().animate({
                        marginTop: 0
...
function(n) {
    ...
    function e() {
        n(document).on("click", ".edgtf-like", function() {
            ...
            a = {
                action: "dishup_edge_like",
                likes_id: a,
                type: e = void 0 !== t.data("type") ? t.data("type") : e,
                like_nonce: n("#edgtf_like_nonce_" + d).val()
            };
